...
export function useGame() {
  ...
  useEffect(() => {
    ...
    const handleSwapEvent = (data: any) => setSwapEvent(data);
    ...
    s.on('game:swap-event', handleSwapEvent as any);
    ...
    return () => {
      ...
      s.off('game:swap-event', handleSwapEvent as any);
    };
  }, []);
  ...
  return {
    ...
    swapEvent,
    clearSwapEvent: () => setSwapEvent(null),
    roundResults,
    gameResults,
    drawFromDeck,
    drawFromDiscard,
