          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                swappedIndex === i && "ring-2 ring-cyan-400 ring-offset-2 ring-offset-black/80 rounded-xl scale-105 shadow-[0_0_20px_rgba(34,211,238,0.8)] z-30 animate-pulse",
              )}
              onClick={() => {
            ...
            >
              {swappedIndex === i && (
                <span className="absolute -top-3.5 left-1/2 -translate-x-1/2 text-[9px] bg-cyan-500 text-black font-black px-2 py-0.5 rounded-full shadow-2xl z-30 whitespace-nowrap animate-bounce border border-cyan-300">
                  {swappedTag || "Troca Valete 🔄"}
                </span>
              )}
